...
<section class="DivBlueET">
  ...
  <section class="graphique">
    <div class="line1">
      <div class="main">
        <div id="charts"></div>
        <p> Le prix des prestations de rénovation énergétique sont jusqu’à 2,8 fois supérieurs aux prix du marché</p>
      </div>
      <div class="two-verticals">
        <div>
          <div id="charts2"></div>
          <p> 87% des consommateurs déclarent avoir un manque de confiance envers les professionnels du BTP</p>
        </div>
        <div>
          <p> Aucun acteur de la rénovation énergétique ne propose une solution globale, cohérente, performante et financièrement juste</p>
        </div>
      </div>
      <div class="clear"></div>
    </div>
    <div class="line2">
      <div class="three-horizontals">
        <div>
          <div id="charts3"></div>
          <p> Seulement 14% des français ont une bonne note énergétique</p>
        </div>
        <div>
          <div id="charts4"></div>
          <p> Le secteur résidentiel représente 30% de la consommation d’énergie en France</p>
        </div>
        <div>
          <div id="charts5"></div>
          <p> 1 français sur deux déclare avoir froid chez lui en hiver</p>
        </div>
      </div>
    </div>
    <div class="clear"></div>
